...
namespace Infrastructure.Data
{
    public class EFRepository<T> : IRepository<T> where T : BaseEntity //class>interface>constrait
    {
        ...
        public async Task<T?> FirtOrDefaultAsync(ISpecification<T> specification)
        {
        ...
        public async Task<List<T>> GetAllAsync(ISpecification<T> specification) //spesifik olarak listeleme sorgusu yapılmak istenebilir. ISpesification interfacesi ile süzerek getirebiliriz. 
        {
